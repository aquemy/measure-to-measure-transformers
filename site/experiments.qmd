...
(the cycle is documented in `WORKFLOW.md`). All 7 experiments are deterministic (`SEED = 0`) and
...
![E1_mass_transport verdict figure](experiments-figures/E1_mass_transport/chain_retention.png){width=100%}
...
![E2_clustering verdict figure](experiments-figures/E2_clustering/contraction_and_rate.png){width=100%}
...
![E3_disentangle verdict figure](experiments-figures/E3_disentangle/separation_over_time.png){width=100%}
...
![E4_matching verdict figure](experiments-figures/E4_matching/selective_motion.png){width=100%}
...
![E5_lyapunov verdict figure](experiments-figures/E5_lyapunov/lyapunov_decrease.png){width=100%}
...
![E6_end_to_end verdict figure](experiments-figures/E6_end_to_end/three_phase.png){width=100%}
...
![E7_linear_impossible verdict figure](experiments-figures/E7_linear_impossible/obstruction_vs_escape.png){width=100%}
