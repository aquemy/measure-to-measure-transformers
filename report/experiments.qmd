...
| `lem-b-2` | Lem B.2, p.31 | math.machine-checked |
| `lem-b-1` | Lem B.1, p.31 | math.machine-checked |
...
| claim | paper node | status |
| --- | --- | --- |
| `prop-2-1` | Prop 2.1, p.11 | math.machine-checked |
...
| `thm-1-2` | Thm 1.2, p.5 | math.axiomatised |
